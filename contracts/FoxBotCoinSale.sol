...
import "./FoxBotCoin.sol";

contract FoxBotCoinSale {
    address payable admin;
    FoxBotCoin public tokenContract;
    uint256 public tokenPrice;
    uint256 public tokensSold;

    event Sell(address _buyer, uint256 _amount);
    event EndSale(uint256 _totalAmountSold);
    // event Testing(uint256 value);

    constructor (FoxBotCoin _tokenContract, uint256 _tokenPrice) public {
        admin = msg.sender;
